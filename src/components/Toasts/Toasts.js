...
export const readToastsAtom = atom(get => get(toastsBaseAtom));

export const deleteToastAtom = atom(null, (get, set, toastId) => {
  const newToasts = [...get(toastsBaseAtom)].filter(oldToast => oldToast.id != toastId);
  set(toastsBaseAtom, newToasts);
});
export const insertToastAtom = atom(null, (get, set, toast) => {

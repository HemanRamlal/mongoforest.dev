  ...
  return ( <>
    ...
    <div className={`lander-page ${authOverlay && "blur"}`}>
      <div className="screen1">
        ...
        { !authOverlay && <Button onClick={toggleAuthOverlay} large className="signup-cta">Learn by doing</Button> }
        { authOverlay && <Button disabled large className="signup-cta">Learn by doing</Button> }
      </div>
      <div className="screen2">
        <img src={playgroundScreenshot} alt="" />
        <div className="playground-screenshot-caption">Chiesel your MongoDB skills by solving problems involving simple finds to complex aggregations</div>
      </div>
      <div className="screen3">
        <div className="header">
          <div className="title"> You can't read your way to mastery</div>
          <div className="subtitle">We give you real challenges : from basic queries to deep aggregations</div>
        </div>
        <div className="cta">
        { !authOverlay && <Button onClick={toggleAuthOverlay} large className="signup-cta">Train now!</Button> }
        { authOverlay && <Button disabled large className="signup-cta">Train now!</Button> }

...
function FindYourAccount({ setPageNo }) {
  ...
  return <div className="find-your-account">
    <div className="recovery-header">
      {submitting ? "Generating a password reset token..." : "Your account was created using which email?"}
    </div>
    <div className="recovery-body">
      ...
      <div className="field-submit">
        <input type="button" className={`recovery-submit ${submitting ? 'recovery-submit-disabled' : ''}`} disabled={submitting} onClick={submitEmail} value="Next" />
      </div>
    </div>
  </div>
}
function ResetPassword() {
  ...
  return <div className="reset-password">
    <div className="recovery-header">
      Check your email's inbox for token value
    </div>
    <div className="recovery-body">
      <div className="fields">
        ...
        <div className="confirm-password-field">
          ...
          <input type="password" name="confirmPassword" id="confirmPassword" value={confirmPassword} onChange={handleConfirmPasswordInput} />
        </div>
      </div>
      <div className="field-submit">
        <input class={`recovery-submit ${submitting ? 'recovery-submit-disabled' : '0'}`} disabled={submitting} onClick={submitReset} value={"Reset Password"}/>
      </div>
    </div>
  </div>
}
